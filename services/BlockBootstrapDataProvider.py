...
from services.BlockSampleDataProvider import BlockSampleDataProvider
...
class BlockBootstrapDataProvider(DataProvider):
    def __init__(self, data_provider: DataProvider, bootstrap_length = 100, block_length = 30):
        ...
        self._bootstrap_samples = [BlockSampleDataProvider(data_provider=data_provider, block_length=block_length) for _ in range(bootstrap_length)]
